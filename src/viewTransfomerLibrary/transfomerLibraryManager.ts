...
export function createWebviewPanel(context: vscode.ExtensionContext, library: TransformerLibrary, transformerManager: TransformerManager, transformersProvider: TransformersProvider, repo: string): vscode.WebviewPanel {
...
function getHtmlForWebview(context: vscode.ExtensionContext, webview: vscode.Webview): string {
    ...
    const scriptUri = webview.asWebviewUri(
        vscode.Uri.joinPath(context.extensionUri, "webview-ui", "dist", "index.js")
    );
    const styleUri = webview.asWebviewUri(
        vscode.Uri.joinPath(context.extensionUri, "webview-ui", "dist", "index.css")
    );
